...
const PetAddingCategory = () => {
  const { go_to_pet_list } = useNavigation();
  ...
  return (
    <View style={styles.container}>
      <Image
        ...
        alt="bg_addpet"
        source={{
          uri: "https://img.freepik.com/free-vector/icons-collection-pets-cats-dogs_603843-127.jpg?w=826&t=st=1697689383~exp=1697689983~hmac=dcf5817b0393920d12089253bf391f17306b36807091deb85317e3f97f94dd13",
        }}
      />
